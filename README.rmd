...
===============
## flumodelr statistics, based on Rstudio mirror
[![CRAN version](https://www.r-pkg.org/badges/version/flumodelr)](https://cran.r-project.org/package=flumodelr)
[![CRAN RStudio mirror downloads](https://cranlogs.r-pkg.org/badges/flumodelr)](https://cran.r-project.org/package=flumodelr)
                                                                 
# Authors
Kevin W. McConeghy, Rob Van Aalst, Andrew Zullo
=======
<img src="images/flumodelr_cdc122ex.jpeg" width=800 height=400 align="center"/>  
[Data obtained from: https://www.cdc.gov/flu/weekly/]
...
### Warning. This package relies heavily on the suite of packages and programming termed "Tidyverse", e.g. "dplyr", "lubridate", that must be installed for proper functioning.  
...
[Introduction to flumodelr](https://github.com/kmcconeghy/flumodelr/blob/master/vignettes/01-introduction.Rmd)  

or if the package is installed:  
```{r, eval=F}
devtools::vignette("01-Introduction", "flumodelr")
```
...
The current objective is to successfully recreate the basic Serfling model. 
...
Thompson WW1, Weintraub E, Dhankhar P, Cheng PY, Brammer L, Meltzer MI, Bresee JS, Shay DK. Estimates of US influenza-associated deaths made using four different methods. Influenza Other Respir Viruses. 2009 Jan;3(1):37-49.[Pubmed Link](https://www.ncbi.nlm.nih.gov/pubmed/19453440)  
