...
A general wrapper, ` mflu() `, for modeling time-series data is written for this purpose. This will compute a traditional serfling model or other generalized linear models, (runs `fluglm()` under the hood), a smoothed model (adds polynomial terms), a model which allows for virology data, and other options explored below.  
